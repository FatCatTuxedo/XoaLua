...
add("xoa", "Xoa Alpha", 255, 255, 255)

addEvent("XoaLuadx.bar:add", true)
addEventHandler("XoaLuadx.bar:add", root, add)
...
addEvent("XoaLuadx.bar:del", true)
addEventHandler("XoaLuadx.bar:del", root, del)
	...
	function ()
		...
		for i = #bar, 1, -1 do
			if (bar[i]) then
				...
				dxDrawText(tostring(bar[i].t)--[[.." | "..i]], sX - baseX, sY - baseY - (i * 19) + 19, sX - 10, sY - 20, tocolor(r, g, b, 255), 1.2, "default-bold", "right", "top", false, false, false, true, false)
